...
EN = [
 ...
 ('Pranchas de surf artesanais feitas no Recreio, Rio de Janeiro, para o Brasil e o mundo.', 'Handmade surfboards shaped in Recreio, Rio de Janeiro, for Brazil and the world.'),
 ('Vocês entregam fora do Rio?', 'Do you ship outside Rio?'),
 ('Entregamos em todo o Brasil e também enviamos para fora do país. A conversa toda acontece online, então você pode estar em qualquer lugar: a gente acerta as medidas pelo site e combina o envio junto com o orçamento. Quem é do Rio pode retirar direto no ateliê, no Recreio.', 'We deliver anywhere in Brazil and we also ship abroad. The whole conversation happens online, so you can be anywhere: we settle the measurements through the site and arrange shipping along with your quote. If you are in Rio, you can pick the board up at the workshop in Recreio.'),
 ('O shaper te retorna pra fechar os detalhes. Entregamos em todo o Brasil e enviamos para o exterior.', 'The shaper gets back to you with the details. We deliver across Brazil and ship worldwide.'),
 ('Recreio dos Bandeirantes, Rio de Janeiro · Entrega em todo o Brasil e exterior · ', 'Recreio dos Bandeirantes, Rio de Janeiro · Shipping across Brazil and worldwide · '),
 ('Shaper artesanal no Recreio (Rio de Janeiro). Pranchas de surf customizadas sob medida, do shape à laminação, do thruster ao longboard. Linha exclusiva Carbon Trash. Entrega em todo o Brasil e envio internacional.', 'Artisan shaper in Recreio, Rio de Janeiro. Custom surfboards made to measure, from shaping to glassing, from thruster to longboard. Exclusive Carbon Trash line. Delivery across Brazil and worldwide shipping.'),
 ('"Envio internacional"', '"Worldwide shipping"'),
...
ES = [
 ...
 ('Pranchas de surf artesanais feitas no Recreio, Rio de Janeiro, para o Brasil e o mundo.', 'Tablas de surf artesanales hechas en Recreio, Río de Janeiro, para Brasil y el mundo.'),
 ('Vocês entregam fora do Rio?', '¿Envían fuera de Río?'),
 ('Entregamos em todo o Brasil e também enviamos para fora do país. A conversa toda acontece online, então você pode estar em qualquer lugar: a gente acerta as medidas pelo site e combina o envio junto com o orçamento. Quem é do Rio pode retirar direto no ateliê, no Recreio.', 'Entregamos en todo Brasil y también enviamos al exterior. Toda la conversación es online, así que puedes estar en cualquier lugar: ajustamos las medidas por el sitio y coordinamos el envío junto con el presupuesto. Si estás en Río, puedes retirar la tabla en el taller, en Recreio.'),
 ('O shaper te retorna pra fechar os detalhes. Entregamos em todo o Brasil e enviamos para o exterior.', 'El shaper te responde para cerrar los detalles. Entregamos en todo Brasil y enviamos al exterior.'),
 ('Recreio dos Bandeirantes, Rio de Janeiro · Entrega em todo o Brasil e exterior · ', 'Recreio dos Bandeirantes, Río de Janeiro · Entrega en todo Brasil y exterior · '),
 ('Shaper artesanal no Recreio (Rio de Janeiro). Pranchas de surf customizadas sob medida, do shape à laminação, do thruster ao longboard. Linha exclusiva Carbon Trash. Entrega em todo o Brasil e envio internacional.', 'Shaper artesanal en Recreio, Río de Janeiro. Tablas de surf personalizadas a medida, del shape al laminado, del thruster al longboard. Línea exclusiva Carbon Trash. Entrega en todo Brasil y envío internacional.'),
 ('"Envio internacional"', '"Envío internacional"'),
